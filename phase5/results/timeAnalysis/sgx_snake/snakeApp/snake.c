...
void log_time(const char *func, double time) {
    if (log_file == NULL || fcntl(fileno(log_file), F_GETFD) == -1) {
        log_file = fopen("snake.log", "a+");
    }

    fprintf(log_file, "%s,%f\n", func, time/CLOCKS_PER_SEC);
}
...
void alarm_handler(int signal __attribute__((unused))) {
    ...
    clock_t end = clock();
    log_time("get_speed", (double) (end - begin));
...
void show_score(screen_t *screen) {
    ...
    clock_t end = clock();
    log_time("get_score", (double) (end - begin));
    ...
    log_time("get_high_score", (double) (end - begin));
...
void setup_level(screen_t *screen, snake_t *snake, int level) {
    ...
    if (1 == level) {
        ...
        clock_t end = clock();
        log_time("reset_score", (double) (end - begin));
        ...
        clock_t end = clock();
        log_time("update_score_level", (double) (end - begin));
    ...
    log_time("get_length", (double) (end - begin));
...
int eat_gold(snake_t *snake, screen_t *screen) {
    ...
    log_time("update_score_gold", (double) (end - begin));

    begin = clock();
    status = increase_length(global_eid);
    check_sgx_status(status, "Could not increase length");
    end = clock();
    log_time("increase_length", (double) (end - begin));
...
int main(void) {
    ...
    init_enclave();
    clock_t end = clock();
    log_time("init_enclave", (double) (end - begin));

    begin = clock();
    load_old_high_score();
    end = clock();
    log_time("load_old_high_score", (double) (end - begin));
    ...
    do {
        ...
        do {
            ...
            log_time("collision", (double) (end - begin));
            ...
            if (collided) {
                ...
                log_time("collide_gold", (double) (end - begin));
    ...
    log_time("save_high_score", (double) (end - begin));
    ...
    log_time("destroy_enclave", (double) (end - begin));
    fclose(log_file);
