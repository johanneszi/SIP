...
void show_score (screen_t *screen)
{
   ...
   gotoxy (61, MAXROW + 2);
   begin = clock();
   int high_score = screen->high_score;
   end = clock();
...
int main (void)
{
   ...
   do
   {
      ...
      do
      {
         ...
         gotoxy (1, 1);
         begin = clock();
         int result = collision(&snake, &screen);
         end = clock();
         ...
         {
            begin = clock();
            result = collide_object(&snake, &screen, GOLD);
            end = clock();
